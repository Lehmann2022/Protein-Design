...
png(file=png_PreDesign,width=800, height=800,res=120)
a <- hist(data$dG_preDesign, main=name1, xlab="Interaction score", xlim=c(-120,-40), col="royalblue")
png(file=png_Comparison,width=800, height=800,res=120)
b <- hist(data$dG_postDesign, xlab="Interaction_score", col="royalblue3")

plot(a, main="Comparison", xlab="Interaction_score", col=rgb(0,0.8,1,1/4), xlim=c(-120,-40))
plot(b, col=rgb(0,0.2,0.6,1/4), xlim=c(-120,-40), add=T)
